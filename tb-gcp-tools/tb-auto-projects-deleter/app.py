...
def main():
    ...
    for project in projects_to_delete_list:
        ...
        print("sa:{}  project:{}  billing:{}  sa:{}  folder_id:{}".format(
            PATH_SA_PERMISSION_SCRIPT, project.name, BILLING_ACCOUNT, build_service_account, folder_id))
        give_build_sa_permission_to_delete(
            PATH_SA_PERMISSION_SCRIPT, project.name, BILLING_ACCOUNT, build_service_account, folder_id)
...
def give_build_sa_permission_to_delete(path_to_script, project_id, billing_account, sa_name, folder_id):
    ...
    cmd = "bash {} {} {} {} {}".format(
        path_to_script, project_id, billing_account, sa_name, folder_id)
