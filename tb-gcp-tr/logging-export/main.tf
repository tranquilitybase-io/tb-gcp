locals {
  log_filter                = "logName=(folders/${var.root_id}/logs/cloudaudit.googleapis.com%2Factivity OR projects/${var.root_id}/logs/cloudaudit.googleapis.com%2Fsystem_event)"
