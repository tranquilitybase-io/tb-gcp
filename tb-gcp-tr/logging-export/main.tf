locals {
  log_filter                = "logName=folders/${var.applications_id}/logs/cloudaudit.googleapis.com%2Fdata_access OR folders/${var.applications_id}/logs/cloudaudit.googleapis.com%2Factivity"
