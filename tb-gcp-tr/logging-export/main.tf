locals {
  log_filter                = "(/logs/cloudaudit.googleapis.com%2Factivity AND /logs/cloudaudit.googleapis.com%2Fdata_access AND /logs/cloudaudit.googleapis.com%2Fsystem_event)"
