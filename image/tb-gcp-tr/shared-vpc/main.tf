...
resource "google_compute_shared_vpc_service_project" "service_project" {
  ...
  #labels          = "${var.tags}"
  depends_on = ["google_compute_shared_vpc_host_project.host", "google_compute_subnetwork.gke", "google_compute_subnetwork.standard"/*, "google_project_services.project_shared"*/]
