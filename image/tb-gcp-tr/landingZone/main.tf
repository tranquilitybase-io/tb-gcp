...
module gke-ssp {
  ...
  cluster_master_authorized_cidrs = "${var.cluster_ssp_master_authorized_cidrs}"
...
module gke-security {
  ...
  cluster_master_authorized_cidrs = "${var.cluster_sec_master_authorized_cidrs}"
...
module gke-operations {
  ...
  cluster_master_authorized_cidrs = "${var.cluster_opt_master_authorized_cidrs}"
...
module "SharedServices_configuration_file" {
  source = "git::https://aadfef28824f0ea635adbfafd75468bd1c4cac44:aadfef28824f0ea635adbfafd75468bd1c4cac44@github.com/tranquilitybase-io/tb-common-tr.git//start_service"
...
module "UI-static-host" {
  ...
  bucket_name     = "tb-ui-host"
  bucket_location = "EU"
  project_id      = "${module.shared_projects.shared_ssp_id}"
  source_bucket   = "gft-tb-self-service-portal-ui-dist"
}
